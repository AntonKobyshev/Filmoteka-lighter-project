 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qt{constructor(e){this.writeTree_=e}static empty(){return new qt(new Wt(null))}}function Ht(e,t,n){if(xe(t))return new qt(new Wt(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const r=i.path;let o=i.value;const s=ke(r,t);return o=o.updateChild(s,n),new qt(e.writeTree_.set(r,o))}{const i=new Wt(n),r=e.writeTree_.setTree(t,i);return new qt(r)}}}function Vt(e,t,n){let i=e;return F(n,((e,n)=>{i=Ht(i,we(t,e),n)})),i}function $t(e,t){if(xe(t))return qt.empty();{const n=e.writeTree_.setTree(t,new Wt(null));return new qt(n)}}function Xt(e,t){return null!=Kt(e,t)}function Kt(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(ke(n.path,t)):null}function Gt(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Qe,((e,n)=>{t.push(new Pe(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new Pe(e,n.value))})),t}function Qt(e,t){if(xe(t))return e;{const n=Kt(e,t);return new qt(null!=n?new Wt(n):e.writeTree_.subtree(t))}}function Jt(e){return e.writeTree_.isEmpty()}function Yt(e,t){return Zt(pe(),e.writeTree_,t)}function Zt(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let i=null;return t.children.inorderTraversal(((t,r)=>{".priority"===t?((0,s.assert)(null!==r.value,"Priority writes must always be leaf nodes"),i=r.value):n=Zt(we(e,t),r,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(we(e,".priority"),i)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
async function We(e,{displayName:t,photoURL:n}){if(void 0===t&&void 0===n)return;const r=(0,i.getModularInstance)(e),o={idToken:await r.getIdToken(),displayName:t,photoUrl:n,returnSecureToken:!0},s=await j(r,
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wt=new E(3e4,6e4);function qt(){const e=rt().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Ht=null;function Vt(e){return Ht=Ht||function(e){return new Promise(((t,n)=>{var i,r,o;function s(){qt(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{qt(),n(m(e,"network-request-failed"))},timeout:Wt.get()})}if(null===(r=null===(i=rt().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=rt().gapi)||void 0===o?void 0:o.load)){const t=yt("iframefcb");return rt()[t]=()=>{gapi.load?s():n(m(e,"network-request-failed"))},gt(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}s()}})).catch((e=>{throw Ht=null,e}))}(e),Ht}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
