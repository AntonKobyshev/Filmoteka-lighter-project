 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wt{constructor(e){this.writeTree_=e}static empty(){return new Wt(new qt(null))}}function Ht(e,t,n){if(xe(t))return new Wt(new qt(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const r=i.path;let o=i.value;const s=ke(r,t);return o=o.updateChild(s,n),new Wt(e.writeTree_.set(r,o))}{const i=new qt(n),r=e.writeTree_.setTree(t,i);return new Wt(r)}}}function Vt(e,t,n){let i=e;return F(n,((e,n)=>{i=Ht(i,we(t,e),n)})),i}function $t(e,t){if(xe(t))return Wt.empty();{const n=e.writeTree_.setTree(t,new qt(null));return new Wt(n)}}function Kt(e,t){return null!=Xt(e,t)}function Xt(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(ke(n.path,t)):null}function Gt(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Qe,((e,n)=>{t.push(new Pe(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new Pe(e,n.value))})),t}function Qt(e,t){if(xe(t))return e;{const n=Xt(e,t);return new Wt(null!=n?new qt(n):e.writeTree_.subtree(t))}}function Yt(e){return e.writeTree_.isEmpty()}function Jt(e,t){return Zt(pe(),e.writeTree_,t)}function Zt(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let i=null;return t.children.inorderTraversal(((t,r)=>{".priority"===t?((0,s.assert)(null!==r.value,"Priority writes must always be leaf nodes"),i=r.value):n=Zt(we(e,t),r,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(we(e,".priority"),i)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
